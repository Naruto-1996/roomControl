...
import com.e.myapplication.audio.AudioPlayManager;
import com.e.myapplication.audio.AudioRecordManager;
import com.e.myapplication.audio.IAudioPlayListener;
import com.e.myapplication.audio.IAudioRecordListener;
...
public class MainPresenter<T extends MainContract.View> implements MainContract.Presenter {
  ...
  public String getDataVoice() {
    return dataVoice;
  }

  public void setDataVoice(String dataVoice) {
    ...
    AudioRecordManager.getInstance(mContext).setAudioRecordListener(new IAudioRecordListener() {
      ...
      public void onFinish(Uri audioPath, int duration) {
        ...
        if (file.exists()) {
          ...
          loadAudioCacheData();
          mView.onVoiceComplete(file.getAbsolutePath());
        }
      }
